...
export function suporteEspertoComportamento(personagemAtivo, personagens) {
  const habilidadesBuffs = [...personagemAtivo.habilidades].filter((habilidade) => habilidade.tipo === ACAO_TIPO.BUFF);
  const habilidadesDebuffs = [...personagemAtivo.habilidades].filter((habilidade) => habilidade.tipo === ACAO_TIPO.DEBUFF);
