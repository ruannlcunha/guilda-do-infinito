...
export function evoluirPersonagem(personagem) {
    ...
    while(personagem.experienciaAtual>=evolucao.experienciaNecessaria
        && personagemEvoluido.level<data.evolucoes.length) {
    ...
    if(personagemEvoluido.level>=data.evolucoes.length
        && personagemEvoluido.experienciaAtual>=evolucao.experienciaNecessaria) {
        personagemEvoluido = {
            ...personagemEvoluido,
