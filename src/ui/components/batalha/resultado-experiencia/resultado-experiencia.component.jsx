    ...
    <section className="experiencia-section">
      ...
      <div className="experiencia-obtida">
        ...
        <div
          className="triangulo"
          style={{
            borderRight: "1rem solid var(--pacific-blue)",
            transform: "scaleX(-1)"
          }}
        ></div>
      </div>
      ...
      <section className="experiencia-personagens" style={aliados.length === 0 ? { alignItems: "center", justifyContent: "center" } : null}>
        {aliados.length > 0 ? (
          aliados.map((personagem, i) => {
            return <CardExperiencia key={i} personagem={personagem} expRecebida={expIndividual} />;
          })
        ) : (
