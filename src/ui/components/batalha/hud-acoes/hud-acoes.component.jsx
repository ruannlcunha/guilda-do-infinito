...
export function HUDAcoes({ personagem, personagens, jogadores, functions }) {
  ...
  function validarAcoesBloqueadas() {
    if(personagem.condicoes.some(condicao=>condicao.nome === CONDICOES.CONGELADO.nome)) {
      setAcoesBloqueadas({ataque: true, habilidades: true, itens: true, extras: false})
    }
    ...
    <>
      <ul className="hud-acoes">
        {personagem.acoesExtras.length>0 ?
          <li
          onMouseEnter={()=>handleHoverSound(acoesBloqueadas.extras)}
          className={acoesBloqueadas.extras?"acao-bloqueada":null}
            onClick={() =>
              selectAcao("Ações Extras", personagem.acoesExtras, acoesBloqueadas.extras)
            }
          >
            Ações Extras
          </li>
        ...
        <li
        onMouseEnter={()=>handleHoverSound(acoesBloqueadas.ataque)}
          className={acoesBloqueadas.ataque?"acao-bloqueada":null}
          onClick={() =>
            selectAcao("Ataques", personagem.ataques, acoesBloqueadas.ataque)
          }
        >
          Atacar
        </li>
        ...
        <li
        onMouseEnter={()=>handleHoverSound(acoesBloqueadas.habilidades)}
          className={acoesBloqueadas.habilidades?"acao-bloqueada":null}
          onClick={() =>
            selectAcao("Habilidades", personagem.habilidades, acoesBloqueadas.habilidades)
          }
        >
          Habilidades
        </li>
        ...
        <li
        onMouseEnter={()=>handleHoverSound(acoesBloqueadas.itens)}
          className={acoesBloqueadas.ataque?"acao-bloqueada":null}
          onClick={() =>
            selectAcao("Itens",personagem.inventario.itens, acoesBloqueadas.itens)
          }
        >
          Itens
        </li>
