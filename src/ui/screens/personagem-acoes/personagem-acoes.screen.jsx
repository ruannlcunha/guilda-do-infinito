          ...
          <div className="lista-acoes">
            <header className="acoes-header">
              <button
                ...
                style={
                  categoria === ACOES_CATEGORIAS.ATAQUES
                    ? {
                        backgroundColor: "var(--blue)",
                        borderRight: "solid 2px var(--dark-blue)",
                        opacity: "100%"
                      }
                    : null
                }
                onClick={() => {
                  setCategoria(ACOES_CATEGORIAS.ATAQUES);
                }}
              >
                Ataques
              </button>
              <button
                onMouseEnter={() => playHover(1)}
                style={
                  categoria === ACOES_CATEGORIAS.HABILIDADES
                    ? {
                        backgroundColor: "var(--blue)",
                        borderRight: "solid 2px var(--dark-blue)",
                        opacity: "100%"
                ...
                onClick={() => {
                  setCategoria(ACOES_CATEGORIAS.HABILIDADES);
                }}
              >
                Habilidades
              </button>
