...
export const COLAR_DEMONIACO = {
  ...
  bonus: [createBonusItem("Vigor", "vigor", 1), createBonusItem("Resistência a Dano (Trevas)", RESISTENCIA_DANO.TREVAS, 5), createBonusItem("Resistência a Dano (Fogo)", RESISTENCIA_DANO.FOGO, 5)]
};
