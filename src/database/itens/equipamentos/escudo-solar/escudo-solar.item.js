...
export const ESCUDO_SOLAR = {
  ...
  bonus: [createBonusItem("Defesa", "defesa", 2), createBonusItem("Resistência a Dano (Luz)", RESISTENCIA_DANO.LUZ, 5), createBonusItem("Resistência a Dano (Fogo)", RESISTENCIA_DANO.FOGO, 5)]
};
