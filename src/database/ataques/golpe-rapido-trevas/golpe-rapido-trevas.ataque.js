...
function golpeRapidoTrevas(personagem, alvo, acao, functions) {
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, GOLPE_RAPIDO_TREVAS, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, GOLPE_RAPIDO_TREVAS,
    )
  }