...
function golpeRapidoAgua(personagem, alvo, acao, functions) {
    ...
    const dado1d6Elemental = rolarDado(1, 6, [], GOLPE_RAPIDO_AGUA.elemento, alvo.elemento)
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, GOLPE_RAPIDO_AGUA, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, GOLPE_RAPIDO_AGUA,
    )
  }