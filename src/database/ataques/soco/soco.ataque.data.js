...
function socoEvento(personagem, alvo, acao, functions) {
    ...
    const dadoDano = rolarDado(1, 4, modificadores, SOCO.elemento, alvo.elemento)
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, [dadoDano], resultadoAtaque, SOCO, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, SOCO,
    )
  }