...
export const INSULTOS_AFIADOS = {
  id: 86,
  nome: "Insultos Afiados",
  dadoDeDano: "1d6+1",
  descricao: "Ataca o inimigo com palavras, causando dano Mental.",
  elemento: ELEMENTOS.MENTAL,
  tipo: ACAO_TIPO.ATAQUE,
  categoria: ACAO_CATEGORIA.MAGICO,
  custo: 1,
  evento: insultosAfiadosEvento,
  alvos: ALVOS.INIMIGOS,
  execucao: ACAO_EXECUCAO.EXTRA,
  variantes: []
};

function insultosAfiadosEvento(personagem, alvo, acao, functions) {
  ...
  realizarEtapasAtaque(
    ...
    () => {
      ...
      const duracao = iniciarEfeito(novoAlvo, functions, EFFECTS.INSULTOS_AFIADOS, ACOES_AUDIO.MAGIA_2);
