...
export const RAJADA_PEDRA = {
    ...
    descricao: "Diversas pedras são arremessadas no inimigo.",
...
function rajadaPedraEvento(personagem, alvo, acao, functions) {
    ...
    const dadoDano = rolarDado(2, 6, modificadores, RAJADA_PEDRA.elemento, alvo.elemento)
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, [dadoDano], resultadoAtaque, RAJADA_PEDRA, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, RAJADA_PEDRA,
    )
  }