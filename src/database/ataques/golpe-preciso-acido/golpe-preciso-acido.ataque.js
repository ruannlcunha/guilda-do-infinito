...
function golpePrecisoAcido(personagem, alvo, acao, functions) {
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, GOLPE_PRECISO_ACIDO, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, GOLPE_PRECISO_ACIDO,
    )
  }