...
export const TIRO_PRECISO_ELETRICO = {
    id: 66,
    nome: "Tiro Preciso (Elétrico)",
    dadoDeDano: "1d8+AGI+1d6(Elétrico)",
    tipo: ATAQUES_TIPO.ATAQUE_PURO,
    descricao: "Um tiro de projétil elétrico mirando com precisão no alvo.",
    elemento: ELEMENTOS.ELETRICO,
    categoria: CATEGORIAS_DE_DANO.DISTANCIA,
    custo: 0,
    evento: tiroPrecisoEletrico,
    alvos: ALVOS.INIMIGOS,
    execucao: ACAO_EXECUCAO.PADRAO,
    variantes: [],
}

function tiroPrecisoEletrico(personagem, alvo, acao, functions) {
    ...
    const dado1d6Elemental = rolarDado(1, 6, [], TIRO_PRECISO_ELETRICO.elemento, alvo.elemento)
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, TIRO_PRECISO_ELETRICO, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, TIRO_PRECISO_ELETRICO,
    )
  }