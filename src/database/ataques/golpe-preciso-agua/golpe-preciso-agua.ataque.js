...
function golpePrecisoAgua(personagem, alvo, acao, functions) {
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, GOLPE_PRECISO_AGUA, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, GOLPE_PRECISO_AGUA,
    )
  }