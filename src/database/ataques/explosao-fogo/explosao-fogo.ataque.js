...
export const EXPLOSAO_FOGO = {
  ...
  dadoDeDano: "1d10",
  descricao: "Uma labareda de chamas que envolve todos os inimigos em combate, podendo deixá-los Queimando.",
...
function explosaoFogoEvento(personagem, alvos, acao, functions) {
  ...
  const modificadores = getModificadoresDano(personagem, null, acao);
