...
export const GOLPE_RAPIDO_LUZ = {
    id: 53,
    nome: "Golpe Rápido (Luz)",
    dadoDeDano: "1d6+FOR+1d6(Luz)",
    tipo: ATAQUES_TIPO.ATAQUE_PURO,
    descricao: "Um golpe de luz veloz que dificulta a esquiva do inimigo.",
    elemento: ELEMENTOS.LUZ,
    categoria: CATEGORIAS_DE_DANO.CORPO_A_CORPO,
    custo: 0,
    evento: golpeRapidoLuz,
    alvos: ALVOS.INIMIGOS,
    execucao: ACAO_EXECUCAO.PADRAO,
    variantes: [],
}

function golpeRapidoLuz(personagem, alvo, acao, functions) {
    ...
    const dado1d6Elemental = rolarDado(1, 6, [], GOLPE_RAPIDO_LUZ.elemento, alvo.elemento)
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, GOLPE_RAPIDO_LUZ, functions);
        const duracao = iniciarEfeito(novoAlvo, functions, EFFECTS.GOLPE_RAPIDO_LUZ, ACOES_AUDIO.CORTE);
        finalizarAcao(functions, novoAlvo, duracao);
      },
      ()=>{
        finalizarAcao(functions, resultadoAtaque.alvo, 0);
      }, resultadoAtaque, functions, personagem, alvo, GOLPE_RAPIDO_LUZ,
    )
  }