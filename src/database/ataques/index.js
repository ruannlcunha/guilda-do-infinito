...
import { GOLPE_ESCUDO } from "./golpe-escudo/golpe-escudo.ataque";
import { GOLPE_PARCEIRO_CORPO } from "./golpe-parceiro-corpo/golpe-parceiro-corpo.ataque";
import { TOQUE_ELETRICO } from "./toque-eletrico/toque-eletrico.ataque";
import { PULSO_SONORO } from "./pulso-sonoro/pulso-sonoro.ataque";
import { GOLPE_PARCEIRO_DISTANCIA } from "./golpe-parceiro-distancia/golpe-parceiro-distancia.ataque";
import { GOLPE_PARCEIRO_MAGICO } from "./golpe-parceiro-magico/golpe-parceiro-magico.ataque";
import { FLECHA_MENTAL } from "./flecha-mental/flecha-mental.ataque";
import { FLECHAS_ARCANAS } from "./flechas-arcanas/flechas-arcanas.ataque";
import { RAIO_ARCANO } from "./raio-arcano/raio-arcano.ataque";
import { GOLPE_AEREO } from "./golpe-aereo/golpe-aereo.ataque";
import { INSULTOS_AFIADOS } from "./insultos-afiados/insultos-afiados.ataque";
import { EXORCIZAR_TREVAS } from "./exorcizar-trevas/exorcizar-trevas.ataque";
...
export const ATAQUES = {
  ...
  EXPLOSAO_FOGO,
  GOLPE_ESCUDO,
  GOLPE_PARCEIRO_CORPO,
  GOLPE_PARCEIRO_DISTANCIA,
  GOLPE_PARCEIRO_MAGICO,
  RAIO_ARCANO,
  GOLPE_AEREO,
  INSULTOS_AFIADOS,
  EXORCIZAR_TREVAS,
