...
function golpePesadoAcido(personagem, alvo, acao, functions) {
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, GOLPE_PESADO_ACIDO, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, GOLPE_PESADO_ACIDO,
    )
  }