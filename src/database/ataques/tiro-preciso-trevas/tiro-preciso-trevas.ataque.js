...
function tiroPrecisoTrevas(personagem, alvo, acao, functions) {
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, TIRO_PRECISO_TREVAS, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, TIRO_PRECISO_TREVAS,
    )
  }