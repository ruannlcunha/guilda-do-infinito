...
export const FLECHA_MENTAL = {
  id: 24,
  nome: "Flecha Mental",
  dadoDeDano: "1d8+1",
  descricao: "Uma flecha mágica que acerta a psique do alvo, podendo deixá-lo Abalado por 1d4 rodadas.",
  elemento: ELEMENTOS.MENTAL,
  tipo: ACAO_TIPO.ATAQUE,
  categoria: ACAO_CATEGORIA.MAGICO,
  custo: 1,
  evento: flechaMentalEvento,
  alvos: ALVOS.INIMIGOS,
  execucao: ACAO_EXECUCAO.PADRAO,
  variantes: []
};

function flechaMentalEvento(personagem, alvo, acao, functions) {
  ...
  realizarEtapasAtaque(
    ...
    () => {
      ...
      const novoAlvo2 = causarAbalado(novoAlvo, "1d4", 10 + personagem.atributos.magia, acao, functions);
      const duracao = iniciarEfeito(novoAlvo2, functions, EFFECTS.FLECHA_MENTAL, ACOES_AUDIO.MAGIA_2);
