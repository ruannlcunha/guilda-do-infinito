...
function tiroPrecisoFogo(personagem, alvo, acao, functions) {
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, TIRO_PRECISO_FOGO, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, TIRO_PRECISO_FOGO,
    )
  }