...
function golpePesadoGelo(personagem, alvo, acao, functions) {
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, GOLPE_PESADO_GELO, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, GOLPE_PESADO_GELO,
    )
  }