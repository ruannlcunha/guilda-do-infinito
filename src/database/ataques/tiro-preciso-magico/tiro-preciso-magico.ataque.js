...
function tiroPrecisoMagico(personagem, alvo, acao, functions) {
    ...
    const dado1d6Elemental = rolarDado(1, 6, [], TIRO_PRECISO_MAGICO.elemento, alvo.elemento)
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, TIRO_PRECISO_MAGICO, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, TIRO_PRECISO_MAGICO,
    )
  }