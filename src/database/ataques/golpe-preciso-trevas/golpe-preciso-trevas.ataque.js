...
function golpePrecisoTrevas(personagem, alvo, acao, functions) {
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, GOLPE_PRECISO_TREVAS, functions);
      ...
      }, resultadoAtaque, functions, personagem, alvo, GOLPE_PRECISO_TREVAS,
    )
  }