...
export const GOLPE_PESADO_ELETRICO = {
    id: 36,
    nome: "Golpe Pesado (Elétrico)",
    dadoDeDano: "1d10+FOR+1d6(Elétrico)",
    tipo: ATAQUES_TIPO.ATAQUE_PURO,
    descricao: "Um golpe elétrico impactante causado por uma arma pesada.",
    elemento: ELEMENTOS.ELETRICO,
    categoria: CATEGORIAS_DE_DANO.CORPO_A_CORPO,
    custo: 0,
    evento: golpePesadoEletrico,
    alvos: ALVOS.INIMIGOS,
    execucao: ACAO_EXECUCAO.PADRAO,
    variantes: [],
}

function golpePesadoEletrico(personagem, alvo, acao, functions) {
    ...
    const dado1d6Elemental = rolarDado(1, 6, [], GOLPE_PESADO_ELETRICO.elemento, alvo.elemento)
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, GOLPE_PESADO_ELETRICO, functions);
        const duracao = iniciarEfeito(novoAlvo, functions, EFFECTS.GOLPE_PESADO_ELETRICO, ACOES_AUDIO.CORTE);
        finalizarAcao(functions, novoAlvo, duracao);
      },
      ()=>{
        finalizarAcao(functions, resultadoAtaque.alvo, 0);
      }, resultadoAtaque, functions, personagem, alvo, GOLPE_PESADO_ELETRICO,
    )
  }