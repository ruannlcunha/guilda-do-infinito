...
export const GOLPE_RAPIDO_GELO = {
    id: 52,
    nome: "Golpe Rápido (Gelo)",
    dadoDeDano: "1d6+FOR+1d6(Gelo)",
    tipo: ATAQUES_TIPO.ATAQUE_PURO,
    descricao: "Um golpe de gelo veloz que dificulta a esquiva do inimigo.",
    elemento: ELEMENTOS.GELO,
    categoria: CATEGORIAS_DE_DANO.CORPO_A_CORPO,
    custo: 0,
    evento: golpeRapidoGelo,
    alvos: ALVOS.INIMIGOS,
    execucao: ACAO_EXECUCAO.PADRAO,
    variantes: [],
}

function golpeRapidoGelo(personagem, alvo, acao, functions) {
    ...
    const dado1d6Elemental = rolarDado(1, 6, [], GOLPE_RAPIDO_GELO.elemento, alvo.elemento)
    ...
    realizarEtapasAtaque(
      ...
      ()=>{
        const novoAlvo = causarDano(resultadoAtaque.alvo, danos, resultadoAtaque, GOLPE_RAPIDO_GELO, functions);
        const duracao = iniciarEfeito(novoAlvo, functions, EFFECTS.GOLPE_RAPIDO_GELO, ACOES_AUDIO.CORTE);
        finalizarAcao(functions, novoAlvo, duracao);
      },
      ()=>{
        finalizarAcao(functions, resultadoAtaque.alvo, 0);
      }, resultadoAtaque, functions, personagem, alvo, GOLPE_RAPIDO_GELO,
    )
  }