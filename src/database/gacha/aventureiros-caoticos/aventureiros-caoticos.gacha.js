...
export const AVENTUREIROS_CAOTICOS = {
  id: 7,
  nome: "Aventureiros Caóticos",
  preview: PREVIEW,
  banner: BANNER,
  possibilidades: [
    {
  ...
  recompensas: [
    {
      recompensa: findGachaPersonagem(37, 2),
      tipo: RECOMPENSAS_TIPO.PERSONAGEM
    },
    {
      recompensa: findGachaPersonagem(38),
      tipo: RECOMPENSAS_TIPO.PERSONAGEM
    },
    {
      recompensa: findGachaPersonagem(39),
      tipo: RECOMPENSAS_TIPO.PERSONAGEM
    },
    {
      recompensa: findGachaPersonagem(40),
      tipo: RECOMPENSAS_TIPO.PERSONAGEM
    },
    {
