...
export const PEDRA_DE_WARUI = {
    id: 4,
    nome: "A Pedra de Warui",
    preview: PREVIEW,
    banner: BANNER,
    possibilidades: [
        {
    ...
    recompensas: [
        {
            recompensa: findGachaPersonagem(5),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(6),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(7),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(8),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(11),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(50),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(51),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(52),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(53),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(54),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(55),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(56),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(57),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaPersonagem(58),
            tipo: RECOMPENSAS_TIPO.PERSONAGEM,
        },
        {
            recompensa: findGachaItem(57),
            tipo: RECOMPENSAS_TIPO.ARMA,
        },
        {
